...
@section('content')
    ...
    <div class="w-1/2 shadow-2xl bg-white rounded-xl mx-auto py-8 pb-5">
        <div class="px-8 justify-center items-center">
                        ...
                        @else
                            ...
                            @foreach ($person as $p)
                                <tr class="border-b bg-neutral-100">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-center">{{ $p['lname'] . ',' . $p['fname'] }}
                                    </td>
                                    <td class="whitespace-nowrap text-center">
                                        <button type="button" data-te-ripple-init data-te-ripple-color="dark"
                                            ...
                                            <svg class="w-3.5 h-3.5 fill-primary" viewBox="0 0 576 512"
            ...
            <form action="{{route('student.store')}}" method="post" class="pt-4" autocomplete="off">
